  ...
  return (
    <div style={{ background: t.navBg, borderBottom: `1px solid ${t.border}`, padding: "12px 18px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ fontFamily: FONT_MONO, fontSize: 18, color: t.hi }}>UNREDACTED <span style={{ fontSize: 12, opacity: 0.8 }}>v1.0.0</span></div>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ fontFamily: FONT_MONO, fontSize: 9, color: t.mid, letterSpacing: 1 }}>
